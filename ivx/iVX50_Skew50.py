...
def main():
    ...
    basic = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权合约基本资料.xlsx', parse_dates=True)
    basic = basic.loc[:, ['trade_code', 'type', 'expire']]
    print('contracts info loaded.')

    # import daily quotes
    data2015 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2015-2016.xlsx', parse_dates=True)
    print('2015-2016 data loaded.')
    data2017 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2017-2018.xlsx', parse_dates=True)
    print('2017-2018 data loaded.')
    data2018 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2018补.xlsx', parse_dates=True)
    print('2018 extra data loaded.')
    data2019 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2019.xlsx', parse_dates=True)
    print('2019 data loaded.')
    data2020 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2020.xlsx', parse_dates=True)
    print('2020 data loaded.')
    data2021 = pd.read_excel('D:\\programs\\volatility\\data\\50ETF期权日行情2021.xlsx', parse_dates=True)
    ...
    data2021 = data2021.loc[:, ['date', 'trade_code', 'strike', 'settle']]
    data = pd.concat([data2015, data2017, data2018, data2019, data2020, data2021], sort=False)
    ...
    # options.to_excel('D:\\programs\\volatility\\data\\50_options_to_day.xlsx')

    shibor = pd.read_excel('D:\\programs\\volatility\\data\\shibor.xlsx', index_col='date')
    ...
    VIX.to_excel('D:\\programs\\volatility\\data\\raw_沪50_VIX.xlsx')

    SKEW = pd.Series(SKEW).sort_index()
    SKEW.to_excel('D:\\programs\\volatility\\data\\raw_沪50_SKEW.xlsx')
